...
const CategoryMultiSelect: React.FC<CategoryMultiSelectProps> = ({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <div className="min-h-[38px] border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 p-2 flex flex-wrap gap-2 items-center">
        ...
        <div className="absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-lg max-h-60 overflow-auto">
          ...
          <div className="p-2 border-b border-gray-200 dark:border-gray-600">
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-brand-blue focus:border-brand-blue dark:bg-gray-900 dark:text-white"
            />
          </div>
