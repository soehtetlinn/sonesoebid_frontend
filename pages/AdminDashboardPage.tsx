...
const AdminDashboardPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-100 border-b border-gray-300 dark:border-gray-800 pb-4">Admin Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md text-center border dark:border-gray-800">
            ...
            <p className="text-4xl font-bold text-brand-teal">{metrics?.totalUsers ?? 0}</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md text-center border dark:border-gray-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md border dark:border-gray-800">
            ...
            <Link to="/admin/products" className="bg-brand-teal text-white font-semibold py-2 px-4 rounded hover:bg-teal-700">
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md border dark:border-gray-800">
            ...
            <Link to="/admin/users" className="bg-brand-teal text-white font-semibold py-2 px-4 rounded hover:bg-teal-700">
              Go to User Management
            </Link>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md border dark:border-gray-800 md:col-span-2">
